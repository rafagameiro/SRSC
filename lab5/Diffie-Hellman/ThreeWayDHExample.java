...
public class ThreeWayDHExample
{
        ...
        throws Exception
    {
        ...
        // 3 x two party agreement
	// Each one must do the appropriate calculus
	// 
        ...
        //      generate the key bytes in each one: A, B and C
        ...
        System.out.println(UtilsDH.toHex(aShared));
        System.out.println(UtilsDH.toHex(bShared));
        System.out.println(UtilsDH.toHex(cShared));
    }
}
